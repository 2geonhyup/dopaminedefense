...
class SummaryPageRecord extends StatefulWidget {
  DefenseModel? defense;
  SummaryPageRecord({Key? key, this.defense}) : super(key: key);

  @override
  State<SummaryPageRecord> createState() => _SummaryPageRecordState();
}

class _SummaryPageRecordState extends State<SummaryPageRecord> {
  DefenseModel? defense;
